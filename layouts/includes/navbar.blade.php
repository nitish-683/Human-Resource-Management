<header class="navbar sticky-top bg-light flex-md-nowrap p-0 shadow" data-bs-theme="light">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="{{ route('candidate.login') }}">{{ config('devstarit.app_name') }}</a>
    ...
    <div class="dropdown me-3 m-auto">
        ...
        <ul class="dropdown-menu dropdown-menu-lg-start border-0 shadow-sm rounded-0">
            ...
            <li><a class="dropdown-item" href="{{ route('candidate.password.index') }}">Change Password</a></li>
